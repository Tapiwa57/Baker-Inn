...
export default function Home() {
  ...
  return (
    <section>
      <div className="flex justify-center flex-wrap max-w-full mt-0.5 mx-8 sm:py-20 md:py-13 lg:py-40 rounded-[10px]"
      style={{
...
>
  <div className="text-white flex  flex-col sm:ml-0 md:ml-[-450px] lg:ml-[-600px]">
    <h1 className="mb-5 font-extrabold text-2xl sm:text-5xl md:text-2xl lg:text-4xl">
      Bringing you the <br />best value at the <br />best prices
    </h1>
    <p className="text-5xl sm:text-xl md:text-2xl mb-5">
      The freshest sandwiches you can make are <br />with Baker&apos;s inn soft white loaf.
    </p>
    <button
      className="border-0 text-lg sm:text-1xl md:text-1xl px-10 font-bold w-50 h-15 mt-5"
...
<div className="flex flex-col md:flex-row max-w-full justify-center items-center md:items-start md:gap-40 gap-20 py-48 text-blue-950">
  <div className=" flex content-center md:text-left">
    <h1 className="text-4xl md:text-4xl font-extrabold">About Us Baker&apos;s Inn</h1>
  </div>
  <div className="text-lg md:text-2xl text-center md:text-left max-w-prose">
    <p>
...
<div className="flex justify-center flex-wrap max-w-full gap-5 mb-36 mt-25 px-4">
  <Image src={About1} alt="About1" className="w-full sm:w-64 md:w-80 lg:w-[300px] h-auto" />
  <Image src={About2} alt="About2" className="w-full sm:w-64 md:w-80 lg:w-[300px] h-auto" />
  <Image src={About3} alt="About3" className="w-full sm:w-64 md:w-80 lg:w-[300px] h-auto" />
  <Image src={About4} alt="About4" className="w-full sm:w-64 md:w-80 lg:w-[300px] h-auto" />
</div>

   <div className="flex flex-col items-center bg-gray-100 max-w-full px-4 py-12">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl mb-12">
    {[
      ...
      <div
        key={item.title}
        className="relative rounded-lg overflow-hidden h-72 sm:h-80 md:h-76"
        style={{
  ...
  <Link href="/Products">
    <button
      className="font-extrabold text-1xl text-white px-5 py-4 rounded-lg"
      style={{ background: "hsla(40, 40%, 50%, 1)" }}
    >
      VIEW COMPLETE RANGE
    </button>
...
<div className="flex flex-col md:flex-row items-center justify-center max-w-full gap-12 px-4 py-16 text-blue-950">
  ...
  <div className="md:w-1/2 flex flex-col">
    <h1 className="text-3xl sm:text-2xl md:text-3xl font-extrabold mb-6 text-center md:text-left">
      Book A Factory Tour
    </h1>
    <p className="text-lg sm:text-1xl md:text-1xl mb-0 text-center md:text-left leading-relaxed">
    ...
    <Link href="/Factoryform">
      <button
        className="text-white text-lg sm:text-xl md:text-1xl font-bold px-6 md:px-5 py-3 md:py-4 mt-4 rounded-lg hover:bg-yellow-700 transition"
        style={{ background: "hsla(40, 40%, 50%, 1)" }}
      >
        BOOK FACTORY TOUR
      </button>
...
<div className="flex flex-col md:flex-row items-center justify-center max-w-full gap-45 px-4 py-16 text-blue-950 bg-gray-100">
  ...
  <div className="md:w-1/2 flex flex-col  md:items-start  md:text-left">
    <h1 className="text-5xl sm:text-2xl md:text-3xl font-extrabold mb-6">
      Request A Donation
    </h1>
    <p className="text-lg sm:text-1xl md:text-1xl mb-6 leading-relaxed">
    ...
    <Link href="/Donationform">
      <button
        className="text-white text-lg sm:text-xl md:text-1xl font-bold px-6 md:px-9 py-3 md:py-4 mt-4 rounded-lg hover:bg-yellow-700 transition"
        style={{
...
<div
  className="flex flex-col items-end justify-center max-w-full mt-0.5 mx-8 rounded-2xl py-24 sm:py-32 md:py-80 text-center "
  style={{
...
>
  <p className="text-white text-md sm:text-1xl md:text-2xl max-w-full mb-6 px-4 mr-20 -mt-">
    Let your children join the fun. Explore a place <br className="" />
    with exciting games and the top winners stand a <br className="" />
    chance to win exciting monthly prizes!
  </p>
  <Link href="/Kidscorner">
    <button
      className="text-white font-extrabold text-md sm:text-xl md:text-2xl px-10 py-5 rounded-lg hover:bg-red-600 transition mr-60"
      style={{
    ...
    <div className="flex max-w-full justify-center py-50 text-blue-950"  style={{flexDirection:"column", alignContent:"center",marginTop:"-250px"}}>
      <Link href="/Recipes"><h1 className="text-4xl font-extrabold mb-40 flex justify-center" style={{}}>Baker&apos;s Recipes</h1></Link>
      <div>
        <Box sx={{ width: '100%' }}>
      ...
      <div className="flex justify-center flex-wrap gap-10" style={{alignContent:"center",}}>
        <div className="" style={{border:"1px solid ", padding:"10px", borderRadius:"10px"}}>
          <Image src={About1} alt="About1" width={350} height={400}></Image>
      ...
      <div className="flex justify-center flex-wrap gap-10" style={{alignContent:"center",}}>
        <div className="" style={{border:"1px solid ", padding:"10px", borderRadius:"10px"}}>
          <Image src={About2} alt="About1" width={350} height={0}></Image>
      ...
      <div className="flex justify-center flex-wrap gap-10" style={{alignContent:"center",}}>
        <div className="" style={{border:"1px solid ", padding:"10px", borderRadius:"10px"}}>
          <Image src={About3} alt="About1" width={350} height={0}></Image>
