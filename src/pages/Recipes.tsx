        ...
        <section>
            <div className="flex justify-center content-center flex-wrap flex-row text-blue-950 gap-20 max-w-full">
                <div className="-ml-7 flex justify-center content-between flex-wrap flex-col">
                    <h1 className="mb-5" style={{fontWeight:"900", fontSize:"32px"}}>The Finest of <br />Baker&apos;s Tik Tok <br />Community Recipes</h1>
                    <p className="text-1xl mb-5">Make the finest croissants worthy of<Image  className="inline"src="/images/eiffel-tower1.svg" alt="tower" width={20} height={20}/> Paris from your <Image className="inline" src="/images/206841-1.svg" alt="tower" width={20} height={20}/> home <br />#Croissant #Zimbabwe #Paris #Baker’s_Inn</p>
                ...
                <div className="flex justify-evenly content-center flex-wrap flex-row max-w-full">
                    <div className="p-10">
                        < Image className="m-2 relative animate-shadowPulse animate-delay-0" style={{animationDelay:"0s"}} src="/images/Rectangle-718.png" alt="hero1" width={250} height={400}/>
                        <Image className="m-2  relative animate-shadowPulse animate-delay-1" style={{animationDelay:"1s"}} src="/images/Rectangle-719.png" alt="hero2" width={250} height={400}/>
                    </div>
                    <div>
                        <Image className="m-2 relative animate-shadowPulse animate-delay-2" style={{animationDelay:"2s"}}src="/images/Rectangle-720.png" alt="hero1" width={250} height={400}/>
                        <Image className="m-2 relative animate-shadowPulse animate-delay-3"style={{animationDelay:"3s"}} src="/images/Rectangle-721.png" alt="hero2" width={250} height={400}/>
                    </div>  
                </div>
            </div>
